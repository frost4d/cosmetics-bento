    ...
    <section className="featured-section" ref={sectionRef}>
      ...
      <div className="product-grid">
        <div className="product-card">
          <img src={process.env.PUBLIC_URL + "/assets/bento/image1.webp"} alt="Velvet Luxe Lipstick" />
          <h3>Velvet Luxe Lipstick</h3>
          <p>Rich pigments, silky texture, and long-lasting wear.</p>
        </div>

        <div className="product-card">
          <img src={process.env.PUBLIC_URL + "/assets/bento/image2.webp"} alt="Foundation" />
          <h3>Radiance Foundation</h3>
          <p>Lightweight coverage that enhances your natural glow.</p>
        </div>

        <div className="product-card">
          <img src={process.env.PUBLIC_URL + "/assets/bento/image4.webp"} alt="Serum" />
